<template>
    <div class="app-container">
        <div style="text-align: center;">导师推荐榜</div>
        ...
        <el-table v-loading="loading" :data="mentorList" @selection-change="handleSelectionChange">
            ...
            <!-- <el-table-column prop="status" :label="$t('pageEventLogs.table.status')" width="180">
                <template slot-scope="scope">
                    <div>
                        <span v-if="scope.row.status === 'OK'"><img src="@/assets/images/correct.png" alt=""></span>
                        <span v-else><img src="@/assets/images/error.png" alt=""></span>
            ...
            <el-table-column label="剩余名额" align="center" prop="remainingNumber" />
            <el-table-column label="招生人数" align="center" prop="studentLimit" />
            <el-table-column label="匹配度" align="center" prop="similarity" />
